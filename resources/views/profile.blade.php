...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/front/css/profile.css')}}">
          ...
          <div class="card card-profile shadow">
            ...
            <div class="card-body pt-0 pt-md-4">
              ...
              <div class="text-center">
                <h3>
                  {{$user->email}}<span class="font-weight-light">, 27</span>
                </h3>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4">
                      <div class="form-group focused">
                        ...
                        <input type="text" id="input-phone" class="form-control form-control-alternative" placeholder="9999999999" value="{{$user->phone}}">
                      </div>
                    </div>
                  </div>
                </div>
